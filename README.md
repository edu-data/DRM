...
| ☑️ 다중선택 체크박스 | 정보원 선택 (친구, 선생님, 부모님, SNS, AI, 기타) |
...
| 시트 | 내용 | 컬럼 수 |
|------|------|---------|
| **Responses** | 종합 응답 (Likert + 개방형) | 27 (A~AA) |
| **Episodes** | 에피소드별 상세 기록 (시간, 활동, 장소, 동행인) | 7 |
| **Diagnoses** | 심층 진단 기록 (정보·정보원·시간·기회·웰빙) | 13 |
